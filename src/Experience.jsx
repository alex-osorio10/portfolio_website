        ...
        <div className="experience-left-container">
          ...
          <div className="experience-left">
            <div className="experience-entry">
              <h3>Alticam Vision - <i>Intern</i> (June 2023 - Aug. 2023)</h3>
            ...
            <div className="experience-entry">
              <h3>IKEA - <i>Goods Flow Co-Worker</i> (Oct. 2021 - June 2024)</h3>
            ...
            <div className="experience-entry">
              <h3>FedEx Ground - <i>Package Handler</i> (Feb. 2023 - June 2023)</h3>
            ...
            <div className="experience-entry">
              <h3>Walmart - <i>Food and Consumables</i> (Feb. 2021 - July 2021)</h3>
            ...
            <div className="experience-entry">
              <h3>Hood River Supply - ACE - <i>Service Station</i> (Nov. 2020 - Jan. 2021)</h3>
            ...
            <div className="experience-entry">
              <h3>Safeway - <i>Courtesy Clerk</i> (Oct. 2019 - Oct. 2020)</h3>
        ...
        <div className="experience-right">
          ...
          <div className="graduation-info">
            <div className="graduation-entry">
              <div className="college-text">
                <p className="college-name-major">
                  Mt. Hood Community College - Computer Science
                </p>
                <p className="graduation-date">Graduation Date: June 2022</p>
              </div>
            ...
            <div className="graduation-entry">
              <div className="college-text">
                <p className="college-name-major">
                  Portland State University - Software Engineering
                </p>
                <p className="graduation-date">Graduation Date: June 2025</p>
              </div>
